...
* Get answers from config.json [Paulo Castro]
* Migrate 'os configure' command to oclif + TypeScript, and fix '--config' option [Paulo Castro]
* Temporary debug settings [Paulo Castro]
